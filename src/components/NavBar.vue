<template>
  <header
    class="fixed w-full border-b border-gray-800 bg-black/90 backdrop-blur-md z-50"
  >
    <div class="flex items-center justify-center h-16 gap-8">
      <div>
      ...
      <nav>
        <ul class="flex items-center justify-center gap-8">
          <li>
            <a
              href="#"
              class="text-gray-300 hover:text-red-500 transition-colors font-medium"
              >Home</a
            >
          </li>
          <li>
      ...
      <div
        id="input__container"
        class="w-md mx-8 flex items-center justify-center"
      >
        <div class="w-full relative">
          ...
          <input
            ...
            class="w-full text-white border border-gray-700 bg-gray-800 rounded-lg py-2 pl-10 pr-4 outline-none focus:border-red-500 focus:ring-red-500 transition-colors"
          />
        </div>
      </div>

      <div class="flex items-center justify-center space-x-4 gap-8">
